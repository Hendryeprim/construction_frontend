        ...
        <div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input type="text" id="name" className="w-full p-4 bg-gray-50 border border-gray-200 outline-none focus:border-accent transition-colors" placeholder="Your Name" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-secondary mb-2" htmlFor="phone">Phone Number</label>
              <input type="tel" id="phone" className="w-full p-4 bg-gray-50 border border-gray-200 outline-none focus:border-accent transition-colors" placeholder="Your Phone Number" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-secondary mb-2" htmlFor="email">Email Address</label>
              <input type="email" id="email" className="w-full p-4 bg-gray-50 border border-gray-200 outline-none focus:border-accent transition-colors" placeholder="Your Email" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-secondary mb-2" htmlFor="interest">I am interested in</label>
              <select id="interest" className="w-full p-4 bg-gray-50 border border-gray-200 outline-none focus:border-accent transition-colors text-concrete">
            ...
            <div>
              ...
              <textarea id="message" rows="5" className="w-full p-4 bg-gray-50 border border-gray-200 outline-none focus:border-accent transition-colors resize-none" placeholder="How can we help you?"></textarea>
            </div>
            <button type="submit" className="w-full bg-secondary text-primary py-4 font-bold tracking-widest hover:bg-accent transition-colors">
              SUBMIT ENQUIRY
            </button>
          </form>
        </div>
