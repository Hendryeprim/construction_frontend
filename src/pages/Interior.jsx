    ...
    >
      ...
      <nav className="p-8 flex justify-between items-center border-b border-[#ffffff20]">
        ...
        <div className="flex gap-8 text-sm tracking-widest text-concrete">
          ...
          <span className="text-secondary">INTERIOR</span>
          <span onClick={() => navigate('/construction')} className="cursor-pointer hover:text-secondary transition-colors">CONSTRUCTION</span>
        </div>
      </nav>
      ...
      <header className="py-24 px-8 md:px-24 bg-gradient-to-b from-[#1a1a1a] to-primary">
        ...
        >
          CURATED SPACES DESIGNED FOR LIVING, WORKING, AND EXPERIENCING. EXPLORE OUR PORTFOLIO OF PREMIUM INTERIORS.
        </motion.p>
      </header>
            ...
            {projects.map((project, index) => {
              ...
              return (
                <motion.div 
                  ...
                  onClick={() => navigate(`/interior/project/${project.id}`)}
                ...
                >
                  ...
                  <div className="flex justify-between items-center text-sm text-concrete tracking-widest">
                    ...
                    <span className="text-accent">{project.category?.name || 'INTERIOR'}</span>
                  </div>
                </motion.div>
              );
            })}
